...
function renderLocalMarkdown(markdown: string): string {
  try {
...
async function fetchAllPortfolios(): Promise<Repository[]> {
...
export async function generateMetadata({
  ...
  return {
    title: `${name} | Projects`,
    description: `Details and branch readmes for the repository: ${name}`,
  };
}
