          ...
          >
            ...
            <div className="relative">
              ...
              <div className="flex flex-col gap-8">
                {/* Standard Card */}
                <div>
                  <h3 className="mb-4 text-sm font-medium text-muted-foreground">Standard Layout</h3>
                  <Card size={size}>
                    <CardHeader>
                    ...
                    <CardContent>
                      <p className="text-sm text-muted-foreground">
                        Here is some content inside the card. You can place anything here.
                      </p>
                    </CardContent>
                    <CardFooter>
                      <Button size={size === "sm" ? "sm" : "default"}>Action</Button>
                    </CardFooter>
                  </Card>
                </div>
                ...
                <div>
                  <h3 className="mb-4 text-sm font-medium text-muted-foreground">With Action in Header</h3>
                  <Card size={size}>
                    <CardHeader>
                      ...
                      <CardAction>
                        <Button variant="outline" size={size === "sm" ? "sm" : "default"}>Edit</Button>
                      </CardAction>
                    </CardHeader>
                    <CardContent>
                      <p className="text-sm text-muted-foreground">
                        Notice how the CardAction component perfectly aligns the button to the right of the header.
                      </p>
                    </CardContent>
                  </Card>
                </div>
