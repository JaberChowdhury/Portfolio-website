...
export function MagicCard(props: MagicCardProps) {
  const {
    ...
    className,
    gradientSize = 200,
    gradientColor = "var(--color-card)",
    gradientOpacity = 0.8,
    gradientFrom = "var(--color-lavender)",
    gradientTo = "var(--color-coral)",
    mode = "gradient",
  } = props

  const glowFrom = isOrbMode(props) ? (props.glowFrom ?? "var(--color-coral)") : "var(--color-coral)"
  const glowTo = isOrbMode(props) ? (props.glowTo ?? "var(--color-cyan)") : "var(--color-cyan)"
