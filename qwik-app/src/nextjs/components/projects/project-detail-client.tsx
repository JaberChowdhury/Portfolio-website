...
export default function ProjectDetailClient({
  ...
  return (
    <div className="container mx-auto min-h-screen max-w-7xl px-4 pt-24 pb-20">
      <div className="mb-8">
        <ProjectHeader repoInfo={repoInfo} />
      </div>

      <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-3">
        {/* Left Column: Readme and Browser Preview */}
        <div className="space-y-8 lg:col-span-2">
          {repoInfo.homepage && (activeBranchName === (repoInfo.default_branch || "main")) && (
          ...
          <div className="w-full">
            ...
            <div className="overflow-hidden rounded-xl border border-border bg-card/50 p-6 text-card-foreground shadow-lg backdrop-blur-sm md:p-10">
        ...
        {/* Right Column: Sticky Sidebar with Controls and Visualizations */}
        <div className="sticky top-24 space-y-8 lg:col-span-1">
          <div className="rounded-xl border border-border bg-card/30 p-6 shadow-sm backdrop-blur-md">
            <h3 className="mb-4 font-mono text-sm font-semibold tracking-tight text-foreground">
              Repository Controls
            </h3>
            <BranchSelector
              repoName={repoName}
